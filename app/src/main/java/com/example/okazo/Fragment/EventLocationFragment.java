...
public class EventLocationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // EventLocationFragment fragment= (EventLocationFragment) getFragmentManager().findFragmentById(R.id.Eve)
...
//                    mLastUpdateTimeLabel, mLastUpdateTime));
    ...
    public void onPause() {
        ...
        if (!mRequestingLocationUpdates) {
            Log.d("STOPUPDATE", "stopLocationUpdates: updates never requested, no-op.");
            return;
        }
